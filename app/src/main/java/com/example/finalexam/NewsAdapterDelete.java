...
public class NewsAdapterDelete extends RecyclerView.Adapter<NewsAdapterDelete.ViewHolder> {
    Context ctx;
    ArrayList<News>listNews;
    NewsDB newsDB;


    public NewsAdapterDelete(Context ctx, ArrayList<News>listNews){
        this.ctx = ctx;
    ...
    @Override
    public void onBindViewHolder(@NonNull NewsAdapterDelete.ViewHolder holder, int position) {
            ...
            btnSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(btnSave.getVisibility() == View.VISIBLE){
                        ...
                        Toast.makeText(ctx, "Delete News", Toast.LENGTH_SHORT).show();
                        setListNews(newsDB.getAllData());
                    }
                }
            });
